...
function useNavForRole(role) {
  ...
  const student = [
    ...
    { label: 'Homework', icon: ClipboardPenLine, to: '/student/homework' },
    { label: 'Course Materials', icon: Library, to: '/student/materials' },
    { label: 'Quizzes', icon: ListChecks, to: '/student/quizzes' },
    { label: 'My Progress', icon: LineChart, to: '/student/insights' },
    { label: 'Calendar', icon: CalendarRange, to: '/student/calendar' },
  ...
  const teacher = [
    ...
    { label: 'Homework', icon: ClipboardPenLine, to: '/teacher/homework' },
    { label: 'Course Materials', icon: Library, to: '/teacher/materials' },
    { label: 'Quizzes', icon: ListChecks, to: '/teacher/quizzes' },
    { label: 'Insights', icon: LineChart, to: '/teacher/insights' },
    { label: 'Calendar', icon: CalendarRange, to: '/teacher/calendar' },
  ...
  const admin = [
    ...
    { label: 'Events', icon: CalendarPlus, to: '/admin/events' },
    { label: 'Calendar', icon: CalendarRange, to: '/admin/calendar' },
